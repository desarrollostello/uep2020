...
<head>
    ...
    <title>{{ trans('uep.site_title') }}</title>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-colorpicker/3.0.0-beta.3/css/bootstrap-colorpicker.css" rel="stylesheet" />
...
<body class="sidebar-mini sidebar-close sidebar-collapse" style="height: auto;">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            ...
            <strong> &copy;</strong> {{ trans('uep.allRightsReserved') }}
        </footer>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.22.2/moment.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-colorpicker/3.0.0-beta.3/js/bootstrap-colorpicker.js"></script>
    ...
    <script>
        $(function() {
  let copyButtonTrans = '{{ trans('uep.datatables.copy') }}'
  let csvButtonTrans = '{{ trans('uep.datatables.csv') }}'
  let excelButtonTrans = '{{ trans('uep.datatables.excel') }}'
  let pdfButtonTrans = '{{ trans('uep.datatables.pdf') }}'
  let printButtonTrans = '{{ trans('uep.datatables.print') }}'
  let colvisButtonTrans = '{{ trans('uep.datatables.colvis') }}'
  ...
  $.fn.dataTable.ext.classes.sPageButton = '';
    ...
    <script>
      ...
      $(function () {
        ...
        // Example using an event, to change the color of the .bg-color background:
        $('#color').on('colorpickerChange', function(event) {
          $('.bg-color').css('background-color', event.color.toString());
        });
      });
      *****/

      //$(".estado-alerta").select2()
      ...
      $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        var modal = $(this)
        modal.find('.modal-title').text("Ayuda para completar el campo: " + recipient )
