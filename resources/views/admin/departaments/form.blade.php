<div class="row align-items-center">
    <div class="col-lg-12 col-sm-12 col-md-12">
        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
            <label for="name">{{ trans('uep.departament.fields.name') }}*</label>
            <button style="padding-left: 0px !important; padding-right: 0px !important; padding-top: 0px !important; padding-bottom: 0px !important; margin-top: -5px !important; color: #cccccc !important" type="button" class="btn" data-toggle="modal" data-target="#exampleModal" data-whatever="nombre" data-mensaje="En este campo deberá completar el nombre que Ud. desee ponerle al Departamento. Este nombre deberá ser identificatorio.">
