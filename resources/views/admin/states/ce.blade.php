...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-12"><h2>{{ trans('uep.edit') }} {{ trans('uep.estado.title_singular') }}</h2></div>
    ...
    @if ($action == 'edit')
        <div class="card-body">
            {!! Form::model($state, ['method' => 'POST', 'route' => ['admin.state.update', $state->id]]) !!}
                @csrf
                @method('PUT')
